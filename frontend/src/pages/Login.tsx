...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-900/20 via-background to-background relative px-4 overflow-hidden">
      ...
      <div className="w-full max-w-md bg-card/40 backdrop-blur-xl border border-border/80 rounded-2xl shadow-xl shadow-black/10 overflow-hidden relative z-10 transition-all p-8 md:p-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-tight">Welcome to Violet</h2>
          <p className="text-sm text-muted-foreground mt-1.5">
            Your second brain & AI personal assistant
          </p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-10 pr-10 py-2.5 bg-secondary/50 border border-border rounded-lg outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-all text-sm"
              />
              <button
                type="button"
